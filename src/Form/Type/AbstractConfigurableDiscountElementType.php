...
use Setono\SyliusBulkDiscountPlugin\Model\ConfigurableDiscountElementInterface;
...
abstract class AbstractConfigurableDiscountElementType extends AbstractResourceType
{
    ...
    /**
     * @param ConfigurableDiscountElementInterface|null $data
     */
    protected function getRegistryIdentifier(FormInterface $form, $data = null): ?string
    {
        if ($data instanceof ConfigurableDiscountElementInterface && null !== $data->getType()) {
            return $data->getType();
        }
